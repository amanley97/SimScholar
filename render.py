    ...
    for key, value in data.items():
        ...
        if isinstance(value, list):
            ...
            dropdown = tk.OptionMenu(
                ...
                var,
                *value,
                command=lambda event=None, t=label, d=key, v=var: update_selected(
                    t, d, v
                ),
            )
            ...
            entry.bind(
                "<KeyRelease>",
                lambda event=None, t=label, d=key, v=intvar: update_selected(t, d, v),
            )
            if label == "cache":
...
def cache_select(type):
    cache_type = sections["cache"][type]
